...
import com.mozhimen.netkfiledownloader.util.Utils.getValue
import com.mozhimen.netkfiledownloader.util.d
...
class DownloadRecord(
    ...
    fun queryByUrl(context: Context): List<DownloadRecord> {
        return buildList {
            ...
            try {
                db = com.mozhimen.netkfiledownloader.DBManager.getDB(context).readableDatabase
    ...
    fun insert(context: Context): Long {
        val rowId = try {
            val db = com.mozhimen.netkfiledownloader.DBManager.getDB(context).writableDatabase
