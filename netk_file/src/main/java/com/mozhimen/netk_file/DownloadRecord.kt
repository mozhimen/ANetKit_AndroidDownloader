...
import com.mozhimen.netk_file.util.Utils.getValue
import com.mozhimen.netk_file.util.d
...
class DownloadRecord(
    ...
    fun queryByUrl(context: Context): List<DownloadRecord> {
        return buildList {
            ...
            try {
                db = com.mozhimen.netk_file.DBManager.getDB(context).readableDatabase
    ...
    fun insert(context: Context): Long {
        val rowId = try {
            val db = com.mozhimen.netk_file.DBManager.getDB(context).writableDatabase
